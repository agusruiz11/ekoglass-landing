...
const WHATSAPP_NUMBER = "541142395000";
const WHATSAPP_MSG = "¡Hola Ekoglass! Quería hacerles una consulta sobre DVH.";
...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      {/* pulso sutil (se desactiva con prefers-reduced-motion) */}
      <span
        aria-hidden
